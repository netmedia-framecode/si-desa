...
CREATE TABLE chat (
  ...
  FOREIGN KEY (sender_id) REFERENCES users(id_user) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (receiver_id) REFERENCES users(id_user) ON UPDATE CASCADE ON DELETE CASCADE
);