...
$_SESSION["project_sistem_informasi_desa"]["name_page"] = "Belum Memiliki KK";
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header border-bottom-0 shadow">
          <h5 class="modal-title" id="tambahLabel">Tambah Surat Keterangan Belum Memiliki KK</h5>
        ...
        <form action="" method="post">
          ...
          <div class="modal-footer justify-content-center border-top-0">
            ...
            <button type="submit" name="add_suket_non_kk" class="btn btn-primary btn-sm">Tambah</button>
          </div>
        </form>
      </div>
    </div>
