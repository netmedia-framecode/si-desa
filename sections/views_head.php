...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['project_sistem_informasi_desa']['name_page'])) {
                          if (!empty($_SESSION['project_sistem_informasi_desa']['name_page'])) {
                            echo " - " . $_SESSION['project_sistem_informasi_desa']['name_page'];
                          }
                        } ?>
</title>
